...
const toc = [
  ...
  { id: "purchases-and-payment", label: "4. PURCHASES AND PAYMENT" },
  { id: "prohibited-activities", label: "5. PROHIBITED ACTIVITIES" },
  { id: "user-generated-contributions", label: "6. USER GENERATED CONTRIBUTIONS" },
  { id: "contribution-license", label: "7. CONTRIBUTION LICENSE" },
  { id: "guidelines-for-reviews", label: "8. GUIDELINES FOR REVIEWS" },
  { id: "advertisers", label: "9. ADVERTISERS" },
  { id: "services-management", label: "10. SERVICES MANAGEMENT" },
  { id: "privacy-policy", label: "11. PRIVACY POLICY" },
  { id: "copyright-infringements", label: "12. COPYRIGHT INFRINGEMENTS" },
  { id: "term-and-termination", label: "13. TERM AND TERMINATION" },
  { id: "modifications-and-interruptions", label: "14. MODIFICATIONS AND INTERRUPTIONS" },
  ...
  { id: "limitations-of-liability", label: "19. LIMITATIONS OF LIABILITY" },
  { id: "indemnification", label: "20. INDEMNIFICATION" },
  { id: "user-data", label: "21. USER DATA" },
  { id: "electronic-communications", label: "22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES" },
...
export function TermsOfUseBody() {
  ...
  return (
    <>
      ...
      <p>
        We are {LEGAL_COMPANY} (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; &quot;our&quot;), a
        company registered in India at {LEGAL_ADDRESS_LINES[0]}, {LEGAL_ADDRESS_LINES[1]}.
      </p>
      <p>
      ...
      <p>
        {LEGAL_COMPANY} is an all-in-one SaaS platform offering smart online tools, AI utilities, and
        productivity solutions to simplify everyday digital tasks for users and businesses.
      </p>
      <p>
        You can contact us by phone at {LEGAL_PHONE}, email at{" "}
        <a href={`mailto:${LEGAL_EMAIL}`} className="text-yellow-700 hover:underline">
          {LEGAL_EMAIL}
        </a>
        , or by mail to {LEGAL_ADDRESS_LINES.join(", ")}.
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or
        on behalf of an entity (&quot;you&quot;), and {LEGAL_COMPANY}, concerning your access to and use of
      ...
      <p>
        ...
        modified Legal Terms will become effective upon posting or notifying you by {LEGAL_EMAIL}, as stated
        in the email message. By continuing to use the Services after the effective date of any changes, you
      ...
      <ol className="list-decimal pl-6 space-y-1">
        {toc.map((item) => (
          <li key={item.id}>
            <a href={`#${item.id}`} className="text-yellow-700 hover:underline">
      ...
      <p>
        <strong>When you post Contributions, you grant us a license (including use of your name, trademarks,
        and logos):</strong> By posting any Contributions, you grant us an unrestricted, unlimited, irrevocable,
        ...
        or otherwise, to prepare derivative works of, or incorporate into other works, your Contributions, and
        to sublicense the licenses granted in this section. Our use and distribution may occur in any media
      ...
      <p>
        ...
        If we remove or edit any such Contributions, we may also suspend or disable your account and report you
        to the authorities.
      </p>
      <p>
      ...
      <h2 id="purchases-and-payment">4. PURCHASES AND PAYMENT</h2>
      <p>All purchases are non-refundable.</p>
      <p>
        We accept the following forms of payment when paid features or products are offered through the
        Services: payment methods displayed at checkout or on the relevant product page at the time of
        purchase.
      </p>
      <p>
      ...
      <p>
        ...
        misleading statements; and (8) you may not organize a campaign encouraging others to post reviews, whether
      ...
      <h2 id="advertisers">9. ADVERTISERS</h2>
      <p>
      ...
      <h2 id="services-management">10. SERVICES MANAGEMENT</h2>
      ...
      <h2 id="privacy-policy">11. PRIVACY POLICY</h2>
      <p>
        ...
        Terms. Please be advised the Services are hosted in India. If you access the Services from any other region
        of the world with laws or other requirements governing personal data collection, use, or disclosure that
        differ from applicable laws in India, then through your continued use of the Services, you are transferring
        your data to India, and you expressly consent to have your data transferred to and processed in India.
      </p>

      <h2 id="copyright-infringements">12. COPYRIGHT INFRINGEMENTS</h2>
      <p>
        We respect the intellectual property rights of others. If you believe that any material available on or
        ...
        Thus, if you are not sure that material located on or linked to by the Services infringes your copyright, you
      ...
      <h2 id="modifications-and-interruptions">14. MODIFICATIONS AND INTERRUPTIONS</h2>
      <p>
      ...
      <p>
        These Legal Terms shall be governed by and defined following the laws of India. {LEGAL_COMPANY} and yourself
        irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may
      ...
      <p>
        ...
        (each a &quot;Dispute&quot; and collectively, the &quot;Disputes&quot;) brought by either you or us (individually, a
      ...
      <p>
        ...
        number of arbitrators shall be one (1). The seat, or legal place, of arbitration shall be Chennai, Tamil Nadu,
        India. The language of the proceedings shall be English. The governing law of these Legal Terms shall be
      ...
      <h2 id="limitations-of-liability">19. LIMITATIONS OF LIABILITY</h2>
      <p>
        ...
        REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SERVICES, EVEN IF WE HAVE BEEN ADVISED OF THE
        ...
        ANY, BY YOU TO US DURING THE SIX (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN US STATE LAWS AND
      ...
      <p>
        ...
        the Services with whom you connected via the Services. Notwithstanding the foregoing, we reserve the right, at your
        expense, to assume the exclusive defense and control of any matter for which you are required to indemnify us, and
        you agree to cooperate, at your expense, with our defense of such claims. We will use reasonable efforts to notify
        you of any such claim, action, or proceeding which is subject to this indemnification upon becoming aware of it.
      </p>

      <h2 id="user-data">21. USER DATA</h2>
      <p>
      ...
      <h2 id="electronic-communications">22. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
      <p>
      ...
      <h2 id="miscellaneous">23. MISCELLANEOUS</h2>
      <p>
        ...
        You hereby waive any and all defenses you may have based on the electronic form of these Legal Terms and the lack
